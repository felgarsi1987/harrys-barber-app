    ...
    <ScreenWrapper>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View entering={FadeInDown.delay(60).springify().damping(18).stiffness(200)} style={styles.avatarSection}>
          ...
          {isBirthday() && (
            <View style={[styles.birthdayPill, { backgroundColor: c.amber + "18", borderColor: c.amber + "44" }]}>
              <Text style={{ fontSize: 14 }}>🎂</Text>
              <Text style={[styles.birthdayText, { color: c.amber }]}>¡Feliz cumpleaños! Tu corte de hoy es gratis</Text>
            </View>
          )}
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(120).springify().damping(18).stiffness(200)}>
          <SectionLabel label="MI CUENTA" c={c} />
        </Animated.View>
        ...
        <Animated.View entering={FadeInDown.delay(160).springify().damping(18).stiffness(200)}
          ...
          >
            <View style={[styles.menuIcon, { backgroundColor: c.amber + "18" }]}>
              <MaterialIcons name="history" size={16} color={c.amber} />
            </View>
        ...
        <Animated.View entering={FadeInDown.delay(220).springify().damping(18).stiffness(200)}>
          <SectionLabel label="PREFERENCIAS" c={c} />
        </Animated.View>

        <Animated.View entering={FadeInDown.delay(260).springify().damping(18).stiffness(200)}
          style={[styles.menuCard, { backgroundColor: c.surface, borderColor: c.border }]}>
        ...
        {/* Logout */}
        <Animated.View entering={FadeInDown.delay(300).springify().damping(18).stiffness(200)}>
          <ScalePress
...
const styles = StyleSheet.create({
  ...
  birthdayText: { fontSize: 12, fontFamily: "SpaceGrotesk_500Medium", flex: 1 },
